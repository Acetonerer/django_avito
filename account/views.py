...
class AccountView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            statistics_response = self.get_monthly_statistics(
                user_id=user_id, account_id=account.account_id
            )

            # Возвращаем успешный ответ
            return Response(
                {"success": True, "account_id": account.account_id},
                        ...
                        for day in range(1, (today - one_month_ago).days + 1):
                            ...
                            stats_entry = next(
                                (
                                    ...
                                    if entry["date"] == stats_date.isoformat()
                                ),
                                None,
                            )
    ...
    def get(self, request, user_id, account_id):
        ...
        try:
            ...
            response_data = {"success": True, "account": serializer.data}
    ...
    def delete(self, request, user_id, account_id):
        ...
        try:
            ...
            account.delete()
            return Response(
                {"success": True, "deletedAccount": {"account_id": account_id}},
    ...
    def get_account_user_id(self, access_token):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return (
                    None,
                    f"Error: Unable to retrieve account_user_id. Status code: {response.status_code}",
                )
